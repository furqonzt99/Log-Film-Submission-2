...
public class HorizontalListFilmAdapter extends RecyclerView.Adapter<HorizontalListFilmAdapter.ListViewHolder> {
    public static final String EXTRA_FILM = "extra_film";
    private ArrayList<Film> listFilm;
    private HorizontalListFilmAdapter.OnItemClickAction onItemClickAction;

    public HorizontalListFilmAdapter(ArrayList<Film> listfilm) {
